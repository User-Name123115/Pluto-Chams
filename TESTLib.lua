...
function library:Window(name) 
    ...
    UiWindow.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- BLACK background
    UiWindow.BorderColor3 = Color3.fromRGB(50, 50, 50) -- Dark gray border
    ...
    Header.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Darker black for header
    Header.BorderColor3 = Color3.fromRGB(50, 50, 50) -- Dark gray border
    ...
    HeaderText.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Black background
    ...
    Minimise.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Black background
    Minimise.BorderColor3 = Color3.fromRGB(50, 50, 50) -- Dark gray border
    ...
    Window.BorderColor3 = Color3.fromRGB(50, 50, 50) -- Dark gray border
    ...
    function functions:Button(name, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray button
        Button.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
    ...
    function functions:Label(text, color)
        local color = color or Color3.fromRGB(255, 255, 255) -- WHITE text default
        ...
        Label.BorderColor3 = Color3.fromRGB(50, 50, 50) -- Dark gray border
    ...
    function functions:Toggle(text, on, callback)
        ...
        ToggleDescription.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- BLACK background
        ...
        ToggleDescription.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        ...
        ToggleButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray
        ToggleButton.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
        ...
        ToggleFiller.BackgroundColor3 = Color3.fromRGB(0, 168, 255) -- Blue for toggle
        ToggleFiller.BorderColor3 = Color3.fromRGB(30, 30, 30) -- Match button background
    ...
    function functions:Box(text, callback)
        ...
        TextBox.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray
        TextBox.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
        TextBox.Position = UDim2.new(0, 99, 0, listOffset[winCount])
        TextBox.Size = UDim2.new(0, 95, 0, 26)
        TextBox.Font = Enum.Font.SourceSans
        TextBox.PlaceholderColor3 = Color3.fromRGB(180, 180, 180) -- Light gray placeholder
        ...
        BoxDescription.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- BLACK background
        ...
        BoxDescription.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
    ...
    function functions:Slider(text, min, max, default, callback)
        ...
        Slider.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray
        Slider.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
        ...
        SliderButton.BackgroundColor3 = Color3.fromRGB(50, 50, 50) -- Dark gray
        SliderButton.BorderColor3 = Color3.fromRGB(100, 100, 100) -- Lighter gray border
        ...
        Current.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        Current.TextSize = 14.000  
        Current.ZIndex = 2 + zindex

        Description.Name = "Description"
        Description.Parent = Slider
        Description.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- BLACK background
        Description.BackgroundTransparency = 1.000
        Description.Position = UDim2.new(0, -10, 0, -35)
        Description.Size = UDim2.new(0, 200, 0, 21)
        Description.Font = Enum.Font.SourceSans
        Description.Text = text
        Description.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        Description.TextSize = 16.000
        Description.ZIndex = 2 + zindex

        SilderFiller.Name = "SilderFiller"
        SilderFiller.Parent = Slider
        SilderFiller.BackgroundColor3 = Color3.fromRGB(0, 168, 255) -- Blue slider filler
        SilderFiller.BorderColor3 = Color3.fromRGB(30, 30, 30) -- Match slider background
        ...
        Max.Name = "Max"
        Max.Parent = Slider
        Max.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- BLACK background
        ...
        Max.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        Max.TextSize = 14.000
    ...
    function functions:Dropdown(text, buttons, callback, selective)
        ...
        Dropdown.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray
        Dropdown.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
        ...
        DownSign.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- BLACK background
        ...
        DownSign.Text = "^"
        DownSign.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        ...
        DropdownFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray
        DropdownFrame.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
        ...
        DropdownFrame.ScrollBarImageColor3 = Color3.fromRGB(255, 255, 255) -- WHITE scrollbar
        ...
        function dropFunctions:Button(name)
            ...
            Button_2.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray
            Button_2.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
            Button_2.Position = UDim2.new(0, 6, 0, canvasSize + 1)
            Button_2.Size = UDim2.new(0, 170, 0, 26)
            Button_2.Selected = true
            Button_2.Font = Enum.Font.SourceSans
            Button_2.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
    ...
    function functions:ColorPicker(name, default, callback)
        ...
        ColorPicker.Text = ""
        ColorPicker.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        ...
        PickerDescription.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- BLACK background
        ...
        PickerDescription.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        ...
        ColorPickerFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- BLACK background
        ColorPickerFrame.BorderColor3 = Color3.fromRGB(50, 50, 50) -- Dark gray border
        ...
        ToggleRGB.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray
        ToggleRGB.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
        ToggleRGB.Position = UDim2.new(0, 125, 0, 127)
        ToggleRGB.Size = UDim2.new(0, 22, 0, 22)
        ToggleRGB.Font = Enum.Font.SourceSans
        ToggleRGB.Text = ""
        ToggleRGB.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        ToggleRGB.TextSize = 14.000
        ToggleRGB.ZIndex = 4 + zindex

        ToggleFiller_2.Name = "ToggleFiller"
        ToggleFiller_2.Parent = ToggleRGB
        ToggleFiller_2.BackgroundColor3 = Color3.fromRGB(0, 168, 255) -- Blue for toggle
        ToggleFiller_2.BorderColor3 = Color3.fromRGB(30, 30, 30) -- Match background
        ...
        ClosePicker.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Dark gray
        ClosePicker.BorderColor3 = Color3.fromRGB(80, 80, 80) -- Gray border
        ClosePicker.Position = UDim2.new(0, 132, 0, 5)
        ClosePicker.Size = UDim2.new(0, 21, 0, 21)
        ClosePicker.Font = Enum.Font.SourceSans
        ClosePicker.Text = "X"
        ClosePicker.TextColor3 = Color3.fromRGB(255, 255, 255) -- WHITE text
        ...
        ColorSlider.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- WHITE slider
